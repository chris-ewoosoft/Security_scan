window.SecurityPortalI18n = (() => {
  ...
  const dict = {
    vi: {
      ...
      "config.depthHint": "Bấm Detail trên nuclei / naabu / feroxbuster / ffuf để mở cấu hình độ sâu. Quick / Balanced / Deep áp dụng preset.",
    ...
    en: {
      ...
      "config.depthHint": "Click Detail on nuclei / naabu / feroxbuster / ffuf to open depth settings. Quick / Balanced / Deep apply presets.",
      "config.depthQuick": "Quick",
      "config.depthBalanced": "Balanced",
      "config.depthDeep": "Deep",
