window.SecurityPortalI18n = (() => {
  ...
  const dict = {
    vi: {
      ...
      "auth.graphqlHint": "Với GraphQL: dán endpoint API (ví dụ …/graphql), không phải trang /login.",
      ...
      "introduce.s1.body": "Security Portal phân tích rủi ro bảo mật của website theo chuẩn OWASP và các tiêu chuẩn thực tế, tạo báo cáo chi tiết về lỗ hổng, cấu hình sai và khuyến nghị khắc phục. Hệ thống hoạt động hoàn toàn tự động — từ quét đến sinh báo cáo PDF.",
    ...
    en: {
      ...
      "auth.graphqlHint": "For GraphQL: paste the API endpoint (e.g. …/graphql), not the /login page.",
      "auth.username": "Username",
      "auth.clinicId": "Clinic / Hospital ID",
      "auth.password": "Password",
      ...
      "introduce.s1.body": "Security Portal analyses website security risks against OWASP standards and real-world best practices, generating detailed reports on vulnerabilities, misconfigurations and remediation recommendations. The system operates fully automatically — from scanning to PDF report generation.",
