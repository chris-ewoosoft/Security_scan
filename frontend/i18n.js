window.SecurityPortalI18n = (() => {
  ...
  const dict = {
    vi: {
      ...
      "config.depthHint": "Chọn Quick / Balanced / Deep hoặc chỉnh severity, tags, ports, threads. Nuclei deep = nhiều template hơn (chậm hơn).",
    ...
    en: {
      ...
      "config.depthHint": "Pick Quick / Balanced / Deep or tune severity, tags, ports, threads. Nuclei deep = more templates (slower).",
      "config.depthQuick": "Quick",
      "config.depthBalanced": "Balanced",
      "config.depthDeep": "Deep",
