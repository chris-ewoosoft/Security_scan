        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    has_https = table.Column<bool>(type: "boolean", nullable: true),
                    server_header = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_website_scans", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_website_scans_created_at",
                table: "website_scans",
                column: "created_at");

            migrationBuilder.CreateIndex(
                name: "ix_website_scans_host",
                table: "website_scans",
                column: "normalized_host");

            migrationBuilder.CreateIndex(
                name: "ix_website_scans_status",
                table: "website_scans",
                column: "status");
        }
